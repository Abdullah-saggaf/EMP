...
const de_updates = {
    "mission": {
        ...
        "body1": "Unsere Geschichte begann 2018 mit einem klaren Ziel: Die Grenzen herkömmlicher Agenturen zu überschreiten...",
        "body2": "Wir verbinden internationales Kapital mit erstklassigen Investitionsmöglichkeiten...",
    ...
    "academyCta": {
        ...
        "subtitle": "Nehmen Sie an unserem hochleistungsfähigen Training teil.",
    ...
    "propertyDetails": {
        ...
        "share": "Teilen",
        "sidebarTitle": "AMP Empire",
        "sidebarDesc": "Premium-Immobilienberatung. Kontaktieren Sie uns für Details.",
    ...
    "aboutPage": {
        ...
        "pillars": {
            ...
            "p1": { "title": "Institutionelles Fundament", "text": "AMP Empire wurde in Warschau gegründet..." },
            "p2": { "title": "Mission", "text": "Standards in der Immobilienbranche auf ein unerreichbares Niveau heben..." },
            "p3": { "title": "Globale Reichweite", "text": "Unser Netzwerk agiert entlang zahlreicher internationaler Kapitalströme..." },
            "p4": { "title": "Das Team", "text": "Bestehend aus erfahrenen Beratern und Experten." }
        },
        "timeline": {
            "sectionLabel": "Die Meilensteine",
            "event1": "Gründung von AMP Empire in Warschau",
            "event2": "Expansion in den Immobilienmarkt",
            "event3": "Start der akademischen Division",
    ...
    "coursesPage": {
        ...
        "enroll": {
            ...
            "subtitle": "Treten Sie dem Elite-Kreis bei.",
    ...
    "contactPage": {
        ...
        "form": {
            ...
            "subtitle": "Kontaktieren Sie unsere Berater.",
...
const es_updates = {
    "mission": {
        ...
        "headline": "Elevando los estándares a niveles <highlight>inalcanzables</highlight>.",
        "body1": "Nuestra historia comenzó en 2018 con un objetivo claro: ir más allá de las limitaciones...",
        "body2": "Conectamos capital internacional con oportunidades de inversión premium...",
        "stats": {"founded": "Fundado", "portfolio": "Valor del Portafolio", "languages": "Idiomas", "divisions": "Divisiones Principales"}
    },
    "featuredProperties": {
    ...
    "academyCta": {
        ...
        "subtitle": "Capacitación de alto rendimiento en el mercado inmobiliario.",
        "viewModules": "Ver Módulos",
        "aboutUs": "Sobre AMP Empire"
    },
    "hero": {
        "badge": "Est. 2018 Sede Varsovia",
        "portfolioCta": "Ver Portafolio"
    },
    "properties": {
        "client": {
            "searchPlaceholder": "Buscar por ciudad, país, tipo...",
            "filterLabel": "Filtrar",
    ...
    "propertyDetails": {
        "recentlyListed": "Nuevo",
        "listedBuilt": "Incluido {year}",
        "save": "Guardar",
        "share": "Compartir",
        "sidebarTitle": "AMP Empire",
        "sidebarDesc": "Asesoramiento Premium. Contáctenos para más detalles.",
    ...
    "aboutPage": {
        ...
        "pillars": {
            ...
            "p1": { "title": "Base Institucional", "text": "Fundada en Varsovia, AMP Empire opera como un centro institucional..." },
            "p2": { "title": "Misión", "text": "Elevar los estándares de servicio inmobiliario..." },
            "p3": { "title": "Alcance Global", "text": "Operando a través de múltiples corredores de capital..." },
            "p4": { "title": "El Equipo", "text": "Compuesto por asesores experimentados." }
        },
        "timeline": {
            "sectionLabel": "Nuestro Viaje",
            "event1": "Fundación en Varsovia",
            "event2": "Expansión en Medio Oriente",
            "event3": "Lanzamiento División Académica",
            "event4": "Valor supera los 2.000 millones de euros",
            "event5": "Plataforma digital en 6 idiomas"
        },
        "legal": {
    ...
    "coursesPage": {
        ...
        "heroWord3": "Avanzada",
        "highlights": {
            "h1": "Sesiones de expertos",
            "h2": "Simulaciones reales",
            "h3": "Enfoque internacional",
            "h4": "Formato en línea",
        ...
        "enroll": {
            ...
            "subtitle": "Únase al círculo élite.",
            "cta": "Registrar Interés"
        }
    },
    "contactPage": {
        "heroSubtitle": "Liderando corredores corporativos.",
        "info": {
            "title": "Base Institucional",
            "legalNameLabel": "Nombre Completo",
        ...
        "form": {
            "title": "Formulario",
            "subtitle": "Conéctese con nuestros asesores.",
...
const tr_updates = {
    "mission": {
        ...
        "headline": "Gayrimenkul standartlarını <highlight>erişilmez</highlight> seviyelere...",
        "body1": "Hikayemiz 2018'de net bir hedefle başladı...",
        "body2": "Derin piyasa analizi temelinde uluslararası sermayeyi birinci sınıf...",
        "stats": {"founded": "Kuruluş", "portfolio": "Portföy", "languages": "Diller", "divisions": "Ana Bölümler"}
    },
    "featuredProperties": {
        "sectionLabel": "Premium Koleksiyon",
        "headline": "Öne Çıkan <highlight>Gayrimenkuller</highlight>",
        "subtitle": "Özel yatırım fırsatları.",
        "cta": "Tüm Gayrimenkulleri Gör"
    },
    "academyCta": {
        "sectionLabel": "Eğitim Akademisi",
        "headline": "<highlight>Premium</highlight> Pazarda Ustalaşın.",
        "subtitle": "Uluslararası gayrimenkul eğitimleri.",
        "viewModules": "Modülleri İncele",
        "aboutUs": "Hakkında"
    },
    "hero": {
        "badge": "2018 Kuruldu",
    ...
    "properties": {
        "client": {
            ...
            "sort": {
                "newest": "En Yeniler",
                "oldest": "En Eskiler",
                "priceDesc": "Yüksekten Düşüğe",
                "priceAsc": "Düşükten Yükseğe"
            },
            "clearBtn": "Temizle",
            "resultsFound": "{count} bulundu",
            "resultFound": "{count} bulundu",
    ...
    "propertyDetails": {
        ...
        "share": "Paylaş",
        "sidebarTitle": "AMP Empire",
        "sidebarDesc": "Premium Gayrimenkul Danışmanlığı.",
    ...
    "aboutPage": {
        ...
        "pillars": {
            ...
            "p1": { "title": "Kurumsal Temel", "text": "Polonya'nın Varşova kentinde..." },
            "p2": { "title": "Misyon", "text": "Uzmanlaşmak..." },
            "p3": { "title": "Global Erişim", "text": "Merkezimiz 6 dil pazarını kapsamaktadır..." },
            "p4": { "title": "Takım", "text": "Deneyimli danışmanlardan..." }
        },
        "timeline": {
            "sectionLabel": "Yolculuğumuz",
            "event1": "AMP Empire kuruldu",
            "event2": "Genişleme",
            "event3": "Akademi açıldı",
            "event4": "Portföy ulaştı",
            "event5": "6 dilli platform"
        },
        "legal": {
            "sectionLabel": "Yasal Sicil",
            "company": "AMP EMPIRE ALEKSANDRA BRZEZIŃSKA",
            "address": "Varşova, Polonya",
            "registry": "NIP: 9541283669",
            "cta": "İletişime Geç"
        },
        "quote": {
            "author": "AMP Empire"
    ...
    "coursesPage": {
        ...
        "highlights": {
            "h1": "Uzman rehberliği",
            "h2": "Gerçek simülasyonlar",
            "h3": "Uluslararası odak",
            "h4": "Esnek format",
            "h5": "Çoklu dil",
            "h6": "Sertifika"
        },
        "enroll": {
            "sectionLabel": "Kayıt Olun",
            "headline": "Başlayın",
            "subtitle": "Elit çevreye katılın.",
            "cta": "Kayıt Formu"
        }
    },
    "contactPage": {
        "heroSubtitle": "Uluslararası sermaye koridorlarına liderlik.",
        "info": {
            "title": "Kurumsal",
            "legalNameLabel": "Yasal Adı",
            "hqLabel": "Ofis",
            "emailLabel": "İletişim",
            "phoneLabel": "Telefon",
            "nipLabel": "NIP",
        ...
        "form": {
            ...
            "subtitle": "Danışmanlarımızla bağlantı kurun.",
            "successTitle": "Alındı",
            "successDesc": "İletişime geçilecektir.",
            "sendAnother": "Başka form gönder",
            "labels": {
                "name": "Adı",
                "email": "E-posta",
                "sector": "Sektör",
...
for (const [filename, updates] of Object.entries(updates_map)) {
    const file_path = path.join(MSG_DIR, filename);
    ...
    const mergedData = deepMerge(data, updates);
    fs.writeFileSync(file_path, JSON.stringify(mergedData, null, 2), 'utf-8');
